...
#     return min
#
# var_1 = input("Input var1\n")
# var_2 = input("Input var2\n")
# var_3 = input("Input var3\n")
#
# var_1 = int(var_1)
# var_2 = int(var_2)
# var_3 = int(var_3)
...
# min = 0
#
# if var_1 == var_2 and var_2 == var_3:                      min = 3
# elif var_1 == var_2 or var_2 == var_3 or var_1 == var_3:   min = 2
#
#
# print("count: " + str(min) + "\n")
...
# Операторы членства        in not in (print(12 in [1, 2, 4, 56]))
# Логические операторы      and or not
# Битовые операторы         &  |  ^ (101 ^ 011 = 110) ~ (not) >> <<
